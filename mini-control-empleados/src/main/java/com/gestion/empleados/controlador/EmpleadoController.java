...
public class EmpleadoController {
	...
	@GetMapping("/ver/{id}")
	public String verDetalleDelEmpleado(@PathVariable(value = "id") Long id, Map<String, Object> modelo,
			RedirectAttributes flash) {
		Empleado empleado = empleadoService.FindOne(id);
		if (empleado == null) {
			flash.addFlashAttribute("empleado", "el Empleado no existe en la base de datos");
